...
class SeedJawabanTableLayout04 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        KunciJawaban::where( 'id', 4 )->delete();
        KunciJawabanDetail::where( 'id_kunci_jawaban', 4 )->delete();

        $kunci_jawaban = "eeeeebcdeabedacbecdabeddeecbbbaddcebdcaebbbbbedddb";
        $array_konversi = ['a' => 0, 'b' => 1, 'c' => 2, 'd' => 3, 'e' => 4, '-' => 5];

        $array_index_pilihan = str_split($kunci_jawaban);
        KunciJawaban::insert([
            ['id' => 4, 'nama' => 'Kunci Jawaban 3'],
        ]);
