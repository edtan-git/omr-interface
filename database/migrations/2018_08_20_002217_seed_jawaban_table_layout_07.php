...
class SeedJawabanTableLayout07 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        KunciJawaban::where( 'id', 7 )->delete();
        KunciJawabanDetail::where( 'id_kunci_jawaban', 7 )->delete();

        $kunci_jawaban = "abdbeebaacbcdeeebdceacdeaedcaebccddedcbaeadcbebcec";
        $array_konversi = ['a' => 0, 'b' => 1, 'c' => 2, 'd' => 3, 'e' => 4, '-' => 5];

        $array_index_pilihan = str_split($kunci_jawaban);
        KunciJawaban::insert([
            ['id' => 7, 'nama' => 'Kunci Jawaban 7'],
        ]);
